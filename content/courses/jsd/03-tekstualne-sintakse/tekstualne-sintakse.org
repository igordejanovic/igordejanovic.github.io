...
Formalne gramatike se mogu klasifikovati prema hijerarhijskoj klasifikaciji
  ...
  - /tipa 1 - kontekstno zavisne/ - produkcije oblika: =αAβ → αγβ=
  - /tipa 2 - kontekstno slobodne/ - produkcije oblika: =A → γ=
  - /tipa 3 - regularne/ - produkcije oblika: =A → a, A → aB=
