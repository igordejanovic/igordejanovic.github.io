...
[[./images/scratch.png]]
** Inform
Inform je jezik za kreiranje interaktivne fikcije (tekstualnih avantura) baziran
na prirodnom jeziku.
#+begin_src text
...
#+end_src
** GritQL
[[https://github.com/getgrit/gritql][GritQL]] je JSD za pretragu, linting i transformaciju koda.
...
** Colobot
- [[https://en.wikipedia.org/wiki/Colobot][Colobot]] je edukativna real-time strategija.
- Igrač programira robote u virtuelnom okruženju JSD-om nalik na C++ i Javu.
