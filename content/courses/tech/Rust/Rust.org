...
=expect= имплементиран на =Ok= варијанти ће вратити вредност која је садржана унутар
варијанте док имплементација над =Err= варијанти прекида извршавање програма.
