...
:END:
** Terminal/shell tricks :linux:shell:terminal:
:PROPERTIES:
...
- source: https://github.com/rafaelrinaldi/til/blob/master/git/list-branches-by-date.md
 ...
 Uses [[https://github.com/mptre/pick][pick]].
...
[[https://stackoverflow.com/questions/16573555/show-conflict-diff-part-of-a-merge][SO post]]
#+begin_src sh
...
See [[https://stackoverflow.com/questions/41592156/git-command-to-remove-local-branches-that-have-a-deleted-upstream][this SO post]].
#+begin_src sh
