...
Takođe je moguće dobiti temu i iz oblasti [[http://www.igordejanovic.net/courses/uks.html][upravljanja konfiguracijom softwera]]
...
- Rad započet: oktobar 2018.
  ...
  web bazirani editor sa bojenjem koda, sklapanjem i komunikacijom sa [Language
  Server Protocol serverom](https://github.com/textX-tools/textX-languageserver)
  (podrškom za IntelliSense). Editor treba da ima minimalne zavisnosti tako da
  se može korisiti u različitim kontekstima (na web-u, kao ugrađeni, kao deo
  desktop aplikacija, kao test editor pri razvoju gramatike i sl.)
  #+end_quote
