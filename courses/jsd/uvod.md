...
![:scale 80%](uvod/MobilneAplikacije.png)
...
![](uvod/MusicNotation-External.png)

---

## ili...

![:scale 90%](uvod/ChessNotation.png)
...
![:scale 60%](uvod/saobracajni-znaci.jpg)
...
![:scale 70%](uvod/AbstractSyntaxTree.svg)
...
![:scale 80%](uvod/GUIDSL-External.png)
...
.center[
![:scale 90%](uvod/xText-tortoise.png)
]
...
.center[
![:scale 85%](uvod/xText-grammar.png)
]
