...
3. Tekstualne sintakse i parsiranje - [[https://github.com/igordejanovic/parglare][parglare]], [[https://github.com/igordejanovic/Arpeggio][Arpeggio]]
4. Apstraktne, konkretne sintakse i metamodelovanje
5. [[https://github.com/igordejanovic/textX][textX]]
6. [[https://github.com/igordejanovic/textx-tools][textX-tools]]
7. Postavka projektnog zadatka - diskusija
8. Primeri - DOMMLite i [[https://github.com/igordejanovic/textx-lang-er][ER]], [[https://github.com/igordejanovic/pyflies][pyFlies]], [[http://www.mobl-lang.org/][mobl]].
9. Transformacije, generisanje koda i interpretiranje - [[http://jinja.pocoo.org/docs/dev/][Jinja2]]
