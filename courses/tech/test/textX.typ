...
#heading(level: 1)[Ovo treba da se vidi u oba eksporta] #label("org7bc4e08")
#enum(enum.item(1)[Prvi],
enum.item(2)[Drugi],
)
Ovaj naslov se ignoriše ali treba da ostane tekst.
#heading(level: 1)[Ovo ne treba da se vidi na slajdovima] #label("org7ad34a4")
Ovo je uvod čiji naslov se ignoriše ali treba da ostane tekst.
#heading(level: 1)[Ovde imamo naslove koji se ignorišu] #label("orgff5f87e")
Ovo ne sme biti na slajdovima
