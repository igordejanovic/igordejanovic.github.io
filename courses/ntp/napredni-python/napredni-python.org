...
Chris Beaumont: [[http://nbviewer.jupyter.org/urls/gist.github.com/ChrisBeaumont/5758381/raw/descriptor_writeup.ipynb][Python Descriptors Demystified]]
** ~__setattr__~ i ~@property~
   
   #+BEGIN_SRC python :return out
   class A:
    @property
    def a(self):
        return 5
...
** ~yield from~
   - Omogućava ulančavanje generatora/koorutina.
...
** Async kod sa ~time.sleep()~ - rezultati
   
  #+RESULTS: time-sleep
  #+begin_example
  Task A: Compute factorial(2)
  SLEEP 2019-03-05 21:17:38.724459
  Task A: Compute factorial(3)
  SLEEP 2019-03-05 21:17:39.726096
  Task A: factorial(3) is 6n
  Task B: Compute factorial(2)
  SLEEP 2019-03-05 21:17:40.727677
  Task B: Compute factorial(3)
  SLEEP 2019-03-05 21:17:41.729207
  Task B: Compute factorial(4)
  SLEEP 2019-03-05 21:17:42.730908
  Task B: factorial(4) is 24n
  Total time: 5.008756875991821
  #+end_example
...
** Async kod sa ~asyncio.sleep(1)~ - rezultati
  ...
  #+begin_example
  Task A: Compute factorial(2)
  SLEEP 2019-03-05 21:16:21.731281n
  Task B: Compute factorial(2)
  SLEEP 2019-03-05 21:16:21.731312n
  Task A: Compute factorial(3)
  SLEEP 2019-03-05 21:16:22.733477n
  Task B: Compute factorial(3)
  SLEEP 2019-03-05 21:16:22.733662n
  Task A: factorial(3) is 6n
  Task B: Compute factorial(4)
  SLEEP 2019-03-05 21:16:23.735448n
  Task B: factorial(4) is 24n
  Total time: 3.006948947906494
  #+end_example
