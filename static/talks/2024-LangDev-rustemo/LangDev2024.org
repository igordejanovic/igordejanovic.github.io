...
#+REVEAL_TITLE_SLIDE: <h2 class="author"><a href="https://igordejanovic.net/">%a</a> (%e)</h2>
...
- An old-school LR parser generator (a.k.a. /compiler-compiler/) ... with a modern twist
...
- Possible further directions
  ...
  - Better disambiguations (static vs. dynamic)
  - Error recovery
  - Incremental parsing
